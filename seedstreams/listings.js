...
// for (let i = 0; i < 134; i++) {
//     if (hash[listings[i].landowner_id] != true) {
//         hash[listings[i].landowner_id] = true;
//         arr.push(listings[i].landowner_id);
//         count++;
//     }
// }
...
// for (let i = 0, j = 0; i < 134; i++) {
//     let rInt = Math.floor(Math.random() * 75);
//     let rInt2 = Math.floor(Math.random() * 75);
//     let newLOID = arr[rInt];
//     if (hash[listings[i].landowner_id] != true) {
//         listings[i].landowner_id = newLOID;
//         // console.log({ newLOID, newl: listings[i] })
//     }
// }

// let missingHashLen = 0;
// for (let i = 0; i < 134; i++) {
//     // if (hash[i] != true) {
//     if (hash[listings[i].landowner_id] != true) {
//         missingHash[i] = true;
...
console.log({
    ...
    missingHash,
    uniqueListings: len,
    uniqueLandOwners: count,
    missingHashLen,
});
let newListingsTableSEED = listings;
...
writeIterableToFile(
    JSON.stringify(newListingsTableSEED),
    "new2ListingsTableSEED.js"
);
